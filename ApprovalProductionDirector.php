        ...
        <div class="col-lg-12">
          <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
              <h3 class="card-title">Director of Production Approval</h3>
            </div>
            <!--begin::Form-->
              ...
              <div class="card-body p-15">
                ...
                <div class="form-group row ">
                  <div class="col-lg-12">
                    ...
                    <div class="radio-inline">
                      <label class="radio">
                        <input type="radio" name="approvalDirProd" value="1" />
                        <span></span>Yes</label>
                      <label class="radio">
                        <input type="radio" name="approvalDirProd" value="0" />
                        <span></span>No, please revise</label>
                      <label class="radio">
                        <input type="radio" name="approvalDirProd" value="2" />
                ...
                <div class="form-group row ">
                  <div class="col-lg-12">
                    ...
                    <textarea class="form-control" id="dirprod_notes"></textarea>
                  </div>
                </div>
              </div>
...
<script>
  $(document).ready(function() {
    $('#form').submit(function(event) {
      ...
      var isApprovedValue = $('input[name="approvalDirProd"]:checked').val();
      var selectedLabel = $('input[name="approvalDirProd"]:checked').closest('label').text().trim();

      var oVars = {
        "approvalDirProd": isApprovedValue,
        "approvalDirProd_label": selectedLabel,
        'dirprod_notes': $('#dirprod_notes').val(),
        'dirprod_notes_label': $('#dirprod_notes').val(),
      };
      pmRestRequest("PUT", "/api/1.0/workflow/cases/<?= $app_uid ?>/variable?del_index=4", false, oVars);
