					...
					<div class="card card-custom">
						<div class="card-body px-5">
							<ul class="navi">
								...
								<li class="navi-item">
									<a class="navi-link" data-toggle="tab" href="#kt_tab_pane_1_4">
								...
								<li class="navi-item">
									<a class="navi-link" data-toggle="tab" href="#kt_tab_pane_2_4">
										<span class="navi-icon"><i class="fa-solid fa-file-export"></i></span>
										<span class="navi-text">Particptd</span>
										<span class="navi-label">
								...
								<li class="navi-item">
									<a class="navi-link" data-toggle="tab" href="#kt_tab_pane_3_4">
								...
								<li class="navi-item">
									<a class="navi-link" data-toggle="tab" href="#kt_tab_pane_4_4">
											...
											<tbody>
												...
												?>
														<tr>
															...
															<td>
																<button type="button" class="btn btn-primary view-button" data-toggle="modal" data-target="#exampleModal" data-app-uid="<?= $d->app_uid ?>">
																	View
																</button>
															</td>
														</tr>
