											...
											<div class="card">
												...
												<div class="card-body">
													...
													<div class="table-responsive">
														<table id="myTable" data-page-length="25" class="table">
															<thead>
																<tr>
																	<th>#</th>
																	<th>Case</th>
															...
															<tbody>
																...
																if (!empty($inbox)) {
																	foreach ($inbox->cases->data as $key => $d) {
																		...
																		// $outputDocs = getOutputDocs($d->app_uid);

																		// $str = "";
																		// foreach ($outputDocs["cases"] as $doc) {
																		// 	$str .= "<a href='http://192.168.1.244:8000/sysworkflow/en/neoclassic/" . $doc->app_doc_link . "'>" . $doc->app_doc_filename . "</a><br>";
																		// }
																?>
																		<tr>
		...
		<script>
			...
			viewButtons.forEach(function(button) {
				button.addEventListener('click', function() {
					...
					// Use AJAX to fetch the API response and update the modal content
