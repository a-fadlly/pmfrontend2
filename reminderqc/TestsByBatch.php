...
<body id="kt_body" style="background-image: url(../assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
                                          ...
                                          <td class="py-3 px-6 text-left">
                                            ...
                                            <?php foreach ($detailArray as $key => $value) { ?>
                                              <div class="mb-3">
                                                ...
                                                <p class="appearance-none text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      const tabs = document.querySelectorAll('.tab-contentl');
      const buttons = document.querySelectorAll('.test-type');

      buttons.forEach(button => {
        button.addEventListener('click', () => {
          tabs.forEach(tab => tab.classList.add('d-none'));
          const targetTabId = button.id.replace('btn', 'tab');
