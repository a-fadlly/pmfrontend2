                                    ...
                                    <div class="card card-custom">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="kt_tab_pane_1_4" role="tabpanel" aria-labelledby="kt_tab_pane_1_4">
                                                ...
                                                <form class="form" method="POST" action="InputTestResult.php">
                                                    <div class="card-body">
                                                        ...
                                                        ?>
                                                            <div class="form-group row">
                                                                <div class="col-lg-12">
                                                                    <label><?= $item[0] ?></label>
                                                                    <input id="<?= $input_name ?>_<?php $key ?>[]" name="<?= $input_name ?>_<?php $key ?>[]" placeholder="<?= isset($item[1]) ? $item[1] : '' ?>" type="text" class="form-control" />
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                    </div>
