        ...
        <div class="col-lg-12">
          <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
              <h3 class="card-title">President Director/Vice President Approval</h3>
            </div>
            <!--begin::Form-->
            <form id="form" class="form">
              <div class="card-body p-15">
                ...
                <div class="form-group row ">
                  <div class="col-lg-12">
                    <label>CFAO's comment:</label>
                    <p><strong><?= $variables->cases->cfaocomment ?></strong></p>
                  </div>
                </div>
                <div class="form-group row ">
                  <div class="col-lg-12">
                    <label>Your Comment:</label>
                    <textarea class="form-control" id="presdir_notes"></textarea>
                  </div>
                </div>
              </div>
...
<script>
  $(document).ready(function() {
    $('#form').submit(function(event) {
      ...
      var oVars = {
        'presdir_notes': $('#presdir_notes').val(),
        'presdir_notes_label': $('#presdir_notes').val(),
      };
      pmRestRequest("PUT", "/api/1.0/workflow/cases/<?= $app_uid ?>/variable?del_index=8", false, oVars);
