        ...
        <div class="col-lg-12">
          <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
              <h3 class="card-title">Approval Dept Head</h3>
            </div>
            <!--begin::Form-->
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  <div class="col-lg-4">
                    ...
                    <p type="text" class="font-weight-bold" id="rqm_nbr"><?= $variables->cases->rqm_nbr_label ?></p>
                  </div>
                  <div class="col-lg-4">
                    <label>Ship To:</label>
                    <p type="text" class="font-weight-bold" id="rqm_nbr"><?= $variables->cases->rqm_ship_label ?></p>
                  </div>
                  <div class="col-lg-4">
                    <label>Entity:</label>
                    <p type="text" class="font-weight-bold" id="rqm_nbr"><?= $variables->cases->rqm_entity_label ?></p>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-lg-4">
                    <label>Requisition Date:</label>
                    <p type="text" class="font-weight-bold" id="rqm_nbr"><?= $variables->cases->rqm_req_date ?></p>
                  </div>
                  <div class="col-lg-4">
                    <label>Need Date:</label>
                    <p type="text" class="font-weight-bold" id="rqm_nbr"><?= $variables->cases->rqm_need_date ?></p>
                  </div>
                  <div class="col-lg-4">
                    <label>Due Date:</label>
                    <p type="text" class="font-weight-bold" id="rqm_nbr"><?= $variables->cases->rqm_due_date ?></p>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-lg-4">
                    <label>Reason:</label>
                    <p type="text" class="font-weight-bold" id="rqm_nbr"><?= $variables->cases->rqm_reason ?></p>
                  </div>
                  <div class="col-lg-4">
                    <label>Cost Center:</label>
                    <p type="text" class="font-weight-bold" id="rqm_nbr"><?= $variables->cases->rqm_cc ?></p>
                  </div>
                  <div class="col-lg-4">
                    <label>Remarks:</label>
                    <p type="text" class="font-weight-bold" id="rqm_nbr"><?= $variables->cases->rqm_rmks ?></p>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-lg-12">
